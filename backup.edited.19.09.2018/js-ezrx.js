...
var materialSearch = function(materialList, dataMaterialAjax) {
    ...
    if (userType === 'csteam' && enableOldMaterialSearch == "false") {
        ...
        $('#resultsTable_filter').find('input').on('keyup', function() {
            ...
            var rulesMaterialSearch = ( window.check_country("TW") || window.check_country("TH") || window.check_country("VN") || window.check_country("MY") )? 2 : 3;
  ...
  var searchCustomerList = function(seachCustomer) {
      ...
      $("#searchCustomerInput").click(function() {
          ...
          var rulesCustomerSearch = ( window.check_country("TW") || window.check_country("TH") || window.check_country("VN") || window.check_country("MY") )? 2 : 3;

          if (inputLength >= rulesCustomerSearch) {
              console.log('click');
  ...
  function transform_newcopypage() {
      ...
      */
      ...
      /*
        ...
        Layout : Desktop
      */
      $(".panel-heading:contains('Materials')").closest(".panel-tl").hide();
