...
var loadAjax = function() {
   ...
   //	console.log("ua====="+ua);
    if (ua.indexOf("MSIE") > 0 || ua.indexOf("Trident") > 0){ // If Internet Explorer, return version number
		param = 'q={$and:[{%22custmasterstring%22:{$regex:%22/' + encodeURIComponent( searchKeyword ) + '/i%22}},{$or:[{%22recrdflag%22 :{$eq:%22A%22}},{%22recrdflag%22:{$eq:%22null%22}}]},{$or:[{%22control_flag%22:{$eq:%22Y%22}},{%22control_flag%22:{$eq:%22null%22}}]}]}&orderby=customer_name:asc';			
